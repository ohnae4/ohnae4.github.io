...
DROP TABLE IF EXISTS RIVERHILL_FAQ;
DROP TABLE IF EXISTS RIVERHILL_NOTICE;
...
(
	...
	CREATE_DATE datetime NOT NULL,
	UPDATE_DATE datetime NOT NULL,
	PRIMARY KEY (RESERVATION_REPLY_NUMBER),
	UNIQUE (RESERVATION_REPLY_NUMBER)
);


CREATE TABLE RIVERHILL_FAQ
(
